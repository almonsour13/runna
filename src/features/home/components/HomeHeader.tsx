...
export default function HomeHeader() {
    ...
    return (
        <RowView className="p-4 pb-0 justify-between gap-8">
            <ColView className="flex-1 gap-0">
                <Text className="text-2xl text-muted-foreground capitalize">
                    Good {greeting}{" "}
                ...
                <Text className="text-2xl text-primary capitalize">
                    {randomPhrase}
                </Text>
            </ColView>
